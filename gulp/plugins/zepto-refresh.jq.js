 ...
 */
 ...
 Refresh.prototype.loadingRender = function(){
     ...
     var refreshTpl = [
         ...
         '.preloader-refresh .icon-refresh {display: inline-block;width: 40px;height: 40px; background: url(css/i/pull-icon@2x.png) no-repeat 0 0;background-size: 40px 80px;-webkit-transition-property:-webkit-transform;-webkit-transition-duration:250ms;-webkit-transform:rotate(0deg) translateZ(0);}',
     ...
     if(this.opts.isRefresh) {
         this.$wrap
             .on('touchstart', function(e) {
                 ...
                 that.startY = e.originalEvent.targetTouches[0].pageY;
             })
 ...
 Refresh.prototype.touchMove = function(e, elem) {
     ...
     var currentX = e.originalEvent.targetTouches[0].pageX - this.startX,
         currentY = e.originalEvent.targetTouches[0].pageY - this.startY;
