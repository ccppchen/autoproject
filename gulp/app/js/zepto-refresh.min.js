 ...
 */
 ...
 Refresh.prototype.touchMove = function(e, elem) {
     ...
     var currentX = (e.originalEvent.targetTouches[0].pageX || e.touches[0].pageX) - this.startX,
         currentY = (e.originalEvent.targetTouches[0].pageY || e.touches[0].pageY) - this.startY;
